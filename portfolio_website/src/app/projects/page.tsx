        ...
        <main className="overflow-hidden px-8 lg:px-16 pb-24 lg:pb-16">
                ...
                <div className="grid lg:grid-rows-2 lg:grid-flow-col pt-8 lg:pt-16 gap-0 lg:gap-16">
                    ...
                    <div className={`row-span-2 border-color-${mood} border-2 rounded-xl mb-32 lg:mb-8`}>
                        ...
                        <h2 className={`text-3xl primary-color-${mood} pt-4 px-8`}>Dokemaca</h2>
                        <h4 className="text-base text-slate-200 pt-4 px-8">This project was my first team project. The project was made for another Howest campus in Bruges (Belgium). Dokemaca consists of 6 custom made interactive poles. Each pole consists of a button, lights, a raspberry pi and a router that runs on a custom Wi-Fi network and on top there is the accompanying website.</h4>
                        <h4 className="text-base text-slate-200 pt-2 px-8">Dokemaca is an interactive game with the objective to get people moving. The participants have to tap on the button of the pole which lights up. There are multiple game modes to choose from, such as “time attack”, “simon says” and “red and blue”. After completing a game, the participants can compare their performances with other players.</h4>
                        <h3 className="text-2xl text-slate-200 pt-4 px-8">Used skills</h3>
                        <div className="flex flex-wrap px-8 py-4">
                              <UsedSkills title="Html & css" years="+2 Year" />
                              <UsedSkills title="Javascript" years="+2 Year" />
