        ...
        <main>
            <div className="w-screen h-90% grid lg:grid-rows-2 lg:grid-flow-col lg:gap-80 justify-items-center lg:pt-28">
                ...
                <div className="row-span-2 lg:mt-12 3xl:mt-24">
                    <h2 className={`text-3xl md:text-4xl 3xl:text-5xl font-medium text-slate-200 pl-10 pt-2 lg:pl-20 lg:pt-8 3xl:pl-0`}>Hello, I am</h2>
                    <h1 className={`text-5xl md:text-6xl 3xl:text-8xl font-bold primary-color-${mood} pt-3 pl-10 lg:pl-20 3xl:pl-0`}>Casper</h1>
                    <h1 className={`text-5xl md:text-6xl 3xl:text-8xl font-bold primary-color-${mood} pl-10 lg:pl-20 3xl:pl-0`}>Van Damme</h1>
