                ...
                <div className="hidden xl:grid row-span-2 pr-36">
                    <div className="grid grid-rows-3 grid-flow-col gap-14">
                        <div className="row-span-3 w-56 pt-20">
                            <h3 className={`xl:text-3xl primary-color-${mood} pt-2 font-${mood}`}>June 2021</h3>
                            <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Finishing high shool with a degree for human sciences</h4>
                            <h3 className={`xl:text-3xl primary-color-${mood} pt-48 font-${mood}`}>June 2022</h3>
                            <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Finishing my first project: Cash Car</h4>
                        </div>
                        <img className="row-span-3" src={`/pictures/timeline-${mood}.png`} alt="Timeline"/>
                        <div className="row-span-3 pt-52 w-56">
                            <h3 className={`xl:text-3xl primary-color-${mood} pt-3 font-${mood}`}>September 2021</h3>
                            <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Starting in mct at Howest</h4>
                            <h3 className={`xl:text-3xl primary-color-${mood} pt-56 font-${mood}`}>February 2023</h3>
                            <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Finishing my first teamproject: Dokemaca</h4>
                        </div>
                    </div>
                </div>
                <div className="hidden lg:block xl:hidden pb-16">
                    <h1 className={`text-4xl font-medium primary-color-${mood} pl-10 xl:hidden block pb-6 font-${mood}`}>history()</h1>
                        <div className="grid grid-rows-2 grid-flow-col w-1/2 pl-32 gap-32">
                            <div className="row-span-2">
                                <h3 className={`xl:text-3xl primary-color-${mood} font-${mood}`}>June 2021</h3>
                                <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Finishing high shool with a degree for human sciences</h4>
                            </div>
                            <div className="row-span-2">
                                <h3 className={`xl:text-3xl primary-color-${mood} font-${mood}`}>June 2022</h3>
                                <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Finishing my first project: Cash Car</h4>
                            </div>                            
                        </div>
                        ...
                        <div className="grid grid-rows-2 grid-flow-col pl-64 pt-10 w-7/12 gap-40">
                            <div className="row-span-2">
                                <h3 className={`xl:text-3xl primary-color-${mood} font-${mood}`}>September 2021</h3>
                            <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Starting in mct at Howest</h4>
                            </div>
                            <div className="row-span-2">
                                <h3 className={`xl:text-3xl primary-color-${mood} font-${mood}`}>February 2023</h3>
                            <h4 className={`xl:text-lg text-color-${mood} font-${mood}`}>Finishing my first teamproject: Dokemaca</h4>
                            </div>                            
                        </div>
                </div>
